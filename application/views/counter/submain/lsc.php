          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Online Sales <span>| Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">General Sales <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Dincount Sales <span>| This Month</span></h5>
